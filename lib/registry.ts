...
export const CALCULATOR_META: CalculatorMeta[] = [
  ...
  { slug: "wilks-score", title: "Wilks Score", category: "Health", description: "Compare powerlifting strength across bodyweight classes.", keywords: ["wilks", "wilks score", "powerlifting", "strength", "bodyweight", "total", "ipf", "competition", "wilks2", "coefficient"] },
  { slug: "plate-calculator", title: "Plate Calculator", category: "Health", description: "Find which weight plates to load on a barbell.", keywords: ["plate calculator", "barbell", "plates", "weight", "powerlifting", "gym", "squat", "bench", "deadlift", "loading", "kg", "lb"] },
  { slug: "training-max", title: "Training Max (5/3/1)", category: "Health", description: "Calculate 5/3/1 training max and working sets from your 1RM.", keywords: ["training max", "531", "5/3/1", "wendler", "powerlifting", "working sets", "percentages", "strength training", "1rm", "programming"] },
  ...
  { slug: "strength-standards", title: "Strength Standards", category: "Health", description: "See how your squat, bench, deadlift, and OHP compare to strength standards.", keywords: ["strength standards", "squat", "bench press", "deadlift", "overhead press", "powerlifting", "beginner", "intermediate", "advanced", "elite", "bodyweight ratio", "strength level"] },
