...
export const CALCULATOR_META: CalculatorMeta[] = [
  ...
  { slug: "torque-converter", title: "Torque Converter", category: "Conversion", description: "Convert between Nm, ft-lb, in-lb, and kgf·m torque units.", keywords: ["torque", "newton meter", "foot pound", "inch pound", "kgf meter", "conversion", "automotive", "engineering", "wrench"] },
  ...
  { slug: "workout-volume", title: "Workout Volume Calculator", category: "Health", description: "Calculate training volume (sets × reps × weight) with MEV/MAV/MRV landmarks.", keywords: ["workout volume", "training volume", "sets reps weight", "mev", "mav", "mrv", "hypertrophy", "progressive overload", "periodization", "rpe"] },
